...
%%
scatterAmpJitter(newTab,params,flags , data);
%%
...
function [] = scatterAmpJitter(tab,params,flags , data)
    figure(); 
    subplot(1,2,1);
    colormap(jet);scatter(tab.rates,tab.amps,params.ScatterPointSize,tab.durations,'filled')%,'MarkerFaceColor',rgb('gray'),'MarkerEdgeColor',rgb('black')); 
    colorbar
